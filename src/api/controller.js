...
exports.addInventory = async (req, res) => {
    try {
        const { itemName, unit, price, op_stock } = req.body;
        
        // Basic validation
        if (!itemName || !unit || !price || !op_stock) {
        ...
        const newInventory = { itemName, unit, price, op_stock, image: imageFilename, createdAt: new Date().toISOString() };
