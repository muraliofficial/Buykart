    ...
    <div className="bg-white rounded-2xl shadow-xs hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 flex flex-col h-full group">
      ...
      <div className="p-5 flex flex-col flex-grow">
        <div className="flex justify-between items-start mb-2">
          <h3 className="font-bold text-gray-900 text-lg line-clamp-1 flex-1 pr-2" title={product.itemName}>
            {product.itemName}
          </h3>
        ...
        <p className="text-gray-500 text-sm mb-5 line-clamp-2 min-h-[40px] leading-relaxed">
        ...
        <div className="mt-auto pt-3 border-t border-gray-50">
          {qty > 0 ? (
            ...
            <button
              ...
              className="w-full bg-[#0D4715] hover:bg-[#41644A] text-white font-bold py-2.5 px-4 rounded-xl transition-all duration-200 shadow-sm hover:shadow-md flex items-center justify-center gap-2 cursor-pointer text-sm"
            >
